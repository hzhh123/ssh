...
function loadIfreame() {
    $('body').append("<div id='load' style='border-radius:5px;width: 150px;padding:10px;position:absolute;top:50%;left:50%;background:#fff;border: 1px solid #ccc;'><img src='../assets/js/loading.gif'> <span style='position:relative;top:0px'>加载中...</span></div>");
    var load=document.getElementById("load");
    var iframe = document.getElementById("iframe");
    iframe.style.display="none";
    $('body').css('background','rgb(119,119,122)');
